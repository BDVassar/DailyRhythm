        ...
        <div class="row justify-content-center">
            <div class="col-8 text-white" id="opaqueBG">
                ...
                <form action="" class="input-group" @submit.prevent="searchImage">
                    <input type="text" placeholder="e.g. beach" name="search"
                        class="form-control search p-1 rounded fs-5" v-model="search.query">
                    <button class="btn btn-info w-25" type="submit" title="Search"><i
